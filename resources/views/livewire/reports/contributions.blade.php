...
<div>
    <div class="flex h-full w-full flex-1 flex-col gap-4">
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-2xl font-bold">{{ __('Contribution Summary Report') }}</h1>
                <p class="text-sm text-neutral-500">{{ __('View contribution summaries by period, plan, and location') }}</p>
            </div>
